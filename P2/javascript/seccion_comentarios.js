...
function cambiar_palabras(){
	var palabras_pro = [ /culo/g, /cago/g, /horrible/g, /marron/g, /odiar/g, /eliminar/g, /succionar/g]; // necesitamos poner una g para que con replace cambien todas las palabras, sino solo cambiaría una
	var censuradas =   [ "****", "****", "********", "******", "*****", "********", "********"]; //aqui están las palabras por las que vamos a reemplazarlas
